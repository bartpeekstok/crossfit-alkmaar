...
export const EVENTS: CfaEvent[] = [
  ...
  },
  {
    ...
    text: "Benieuwd wat voeding voor jouw resultaten kan betekenen? Op donderdagavond 16 juli zit PEP bij ons in de box voor gratis miniconsults van 15 minuten. Schrijf je in voor een van de slots in SportBit, stel je vragen over eten rondom je training of herstel en loop weg met concrete tips die je meteen kunt toepassen. Kort, persoonlijk en helemaal vrijblijvend.",
    slideText: "Gratis miniconsult voeding met PEP (15 min). Schrijf je in voor een slot in SportBit.",
    time: "Donderdagavond",
    place: "CrossFit Alkmaar",
  },
  {
  ...
  {
    href: "https://cfalkmaar.sportbitapp.nl/web/nl/events/72901",
    external: true,
    ctaLabel: "Schrijf je in",
    title: "Oly Cursus",
    dateLabel: "Zes vrijdagen vanaf 11 september 2026",
    isoDate: "2026-09-11",
    tag: "Inschrijving open",
    img: "/redesign/assets/event-oly-cursus.jpg",
    imgAlt: "Coach geeft techniekaanwijzingen aan een atleet met de barbell tijdens de Oly Cursus bij CrossFit Alkmaar",
    text: "Werk aan je clean & jerk en aan je snatch! Zes weken lang een uur techniek en kracht voor je lift-skills, met als doel technisch prachtige lifts, meer vertrouwen met de barbell en gewichten, en misschien uiteindelijk wel PR's op je snatch en clean & jerk.",
    slideText: "Zes weken techniek en kracht voor je snatch en clean & jerk. Technisch mooiere lifts en meer vertrouwen met de barbell.",
    time: "20:15, een uur",
    place: "CrossFit Alkmaar",
  },
  {
    ...
    isoDate: "2026-09-13",
    tag: "Inschrijving open",
    img: "/redesign/assets/header-hardest-mile.jpg",
    imgAlt: "Atletiekbaan met genummerde banen, het decor van The Hardest Mile",
    text: "Vier keer vierhonderd meter: burpees, lunges, bearcrawl en hardlopen. Solo of met een buddy, voor alle niveaus, op de atletiekbaan van AV Hylas.",
    slideText: "4x 400m: burpees, lunges, bearcrawl en hardlopen. Solo of met een buddy.",
    time: "12:30 start",
    place: "Atletiekvereniging Hylas",
  },
  {
    href: "https://cfalkmaar.sportbitapp.nl/web/nl/events/73062",
    external: true,
    ctaLabel: "Schrijf je in",
