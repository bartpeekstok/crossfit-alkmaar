...
export const EVENTS: CfaEvent[] = [
  ...
  {
    href: "/hyrox-prep",
    ctaLabel: "Zet je op de wachtlijst",
    title: "HYROX Prep: 8 weken naar Utrecht",
    dateLabel: "Start zondag 4 oktober 2026",
    isoDate: "2026-10-04",
    tag: "Wachtlijst open",
    img: "/redesign/assets/header-hyrox.jpg",
    imgAlt: "Atleten trainen voor HYROX bij CrossFit Alkmaar",
    text: "Acht weken gericht toewerken naar HYROX Utrecht (26 t/m 30 november). Twee trainingen per week, maximaal 16 deelnemers. Wie op de wachtlijst staat, krijgt 24 uur voorsprong bij de inschrijving en 50 euro korting.",
    slideText: "8 weken voorbereiding op HYROX Utrecht. Max 16 plekken, wachtlijst open.",
    time: "Wo 19:00 en zo 09:00",
    place: "CrossFit Alkmaar",
  },
  {
