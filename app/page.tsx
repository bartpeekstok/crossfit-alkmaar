          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <div className="bg-gray-800 rounded-lg overflow-hidden aspect-video mb-4">
                <iframe className="w-full h-full" src="https://www.youtube.com/embed/G9HkOnSsKg8" title="CrossFit Alkmaar testimonial 1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
              </div>
              <h3 className="text-xl font-semibold mb-2">Ik dacht dat CrossFit niets voor mij was</h3>
              <p className="text-gray-600">Marieke (52) vertelt hoe ze van nul naar 3x per week trainen ging en zich nu fitter voelt dan ooit.</p>
            </div>
            <div>
              <div className="bg-gray-800 rounded-lg overflow-hidden aspect-video mb-4">
                <iframe className="w-full h-full" src="https://www.youtube.com/embed/a2zbZIlU27Y" title="CrossFit Alkmaar testimonial 2" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
              </div>
              <h3 className="text-xl font-semibold mb-2">Geen tijd was altijd mijn excuus</h3>
              <p className="text-gray-600">Robert (47) legt uit hoe hij als drukke ondernemer toch 2x per week traint en meer energie heeft.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">Ideaal om te starten. 4 weken begeleide training, uitleg van alle bewegingen, en een solide basis leggen.</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">Onze standaard groepstrainingen. Gevarieerd, uitdagend, en altijd schaalbaar naar jouw niveau.</p>
              <ul className="space-y-2 mb-6 text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">Specifiek krachtprogramma in kleine groepen. Focus op sterker worden met barbells en structuur.</p>
              <ul className="space-y-2 mb-6 text-gray-700">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg">
            <p className="text-lg italic text-gray-700 mb-4">Ik ben 58 en dacht dat dit niets voor mij was. Na de Kickstart train ik nu 3x per week en voel me beter dan 10 jaar geleden. De coaches passen alles aan en ik train veilig.</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">Absoluut niet. Onze gemiddelde leeftijd is 50+. We hebben leden van 60, 65, 70+ die veilig en effectief trainen. Juist op latere leeftijd is krachtraining essentieel voor mobiliteit en gezondheid.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
