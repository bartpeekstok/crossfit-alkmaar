...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.crossfitalkmaar.com/crossfit-beginners-alkmaar",
  },
  openGraph: {
    title: "CrossFit voor Beginners Alkmaar | CrossFit Alkmaar",
    description:
      "CrossFit voor beginners in Alkmaar. Start veilig met persoonlijke begeleiding via het Kickstart-traject bij CrossFit Alkmaar.",
    url: "https://www.crossfitalkmaar.com/crossfit-beginners-alkmaar",
    siteName: "CrossFit Alkmaar",
    locale: "nl_NL",
    type: "website",
    images: [
      {
        url: "https://www.crossfitalkmaar.com/images/crossfit-beginners-header.jpg",
        width: 1200,
        height: 630,
