...
// Evergreen simulatiepagina: toont altijd de eerstvolgende editie.
// Startlijst en leaderboard van eerdere edities blijven bereikbaar via
// /hyrox-simulatie-alkmaar/startlijst en /leaderboard (rewrite in next.config.ts).
export default function HyroxSimulatieAlkmaar() {
  return (
    <>
