      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 items-center opacity-70">
            <Image src="/images/kilo-logo.png" alt="KILO" width={60} height={30} className="h-6 w-auto" />
            <Image src="/images/crossfit-logo.png" alt="CrossFit" width={60} height={30} className="h-6 w-auto" />
            <Image src="/images/twobrain-logo.png" alt="Two-Brain Business" width={60} height={30} className="h-6 w-auto" />
          </div>
        </div>
