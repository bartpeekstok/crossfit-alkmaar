...
import { useTienersPopup } from "./TienersPopupContext";

export default function TienersPopup() {
  const { isOpen, closePopup } = useTienersPopup();
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl max-w-md w-full mx-4 z-[101] overflow-hidden">
        ...
        {/* GHL Form Embed - Tieners */}
        <div style={{ height: '380px', overflow: 'hidden' }}>
          <iframe
            src="https://ghl.crossfitalkmaar.com/widget/form/lgMEyIvjxV4PUWYQp0jq"
            style={{ width: '100%', height: '450px', border: 'none', marginTop: '-30px' }}
            scrolling="no"
            id="popup-lgMEyIvjxV4PUWYQp0jq"
            title="Tieners form"
          />
        </div>
      </div>
