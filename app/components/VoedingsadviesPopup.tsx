...
import { useVoedingsadviesPopup } from "./VoedingsadviesPopupContext";

export default function VoedingsadviesPopup() {
  const { isOpen, closePopup } = useVoedingsadviesPopup();
