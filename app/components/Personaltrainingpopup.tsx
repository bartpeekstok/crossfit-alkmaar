...
import { usePersonalTrainingPopup } from "./PersonalTrainingPopupContext";

export default function PersonalTrainingPopup() {
  const { isOpen, closePopup } = usePersonalTrainingPopup();
