...
/**
 * Bedankt-pagina na een Hardest Mile-betaling. Zelfde mechaniek als
 * /hyrox-betaald: op ons eigen domein zodat de globale Meta Pixel hier vuurt
 * (PageView automatisch + Purchase hieronder).
 *
 * Bedrag (centen) + order-id komen mee in de URL (zie api/hardest-mile-betaling.js
 * in repo hyrox-betaling-backend). eventID = order-id = hetzelfde event_id als het
 ...
 */
export default function HardestMileBetaaldPage() {
    ...
    <div className="hb-wrap">
      ...
      {cancelled ? (
        <div className="hb-card">
          <p className="hb-eb">The Hardest Mile · CrossFit Alkmaar</p>
        ...
        <div className="hb-card">
          ...
          <p>Je betaling is gelukt en je plek staat vast. Je krijgt een bevestiging per e-mail. Tot op de baan! 💪</p>
          <a className="hb-btn" href="https://www.crossfitalkmaar.nl">Terug naar de site</a>
        </div>
      )}
    </div>
