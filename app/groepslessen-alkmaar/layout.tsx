...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.crossfitalkmaar.com/groepslessen-alkmaar",
  },
  openGraph: {
    title: "Groepslessen Alkmaar | CrossFit Alkmaar",
    description:
      "Groepslessen met professionele coaching in kleine groepen van max 12. CrossFit, Strength, HYROX en BUILD bij CrossFit Alkmaar.",
    url: "https://www.crossfitalkmaar.com/groepslessen-alkmaar",
    siteName: "CrossFit Alkmaar",
    locale: "nl_NL",
    type: "website",
    images: [
      {
        url: "https://www.crossfitalkmaar.com/images/groepslessen-alkmaar-header.jpg",
        width: 1200,
        height: 630,
